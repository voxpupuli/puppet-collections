...
* [`collections::checkpoint`](#collections--checkpoint): A short summary of the purpose of this defined type.
...
* [`collections::file::writer`](#collections--file--writer): Write collected data to a file
* [`collections::iterator`](#collections--iterator): The resource that calls actions and executors upon a collection
...
### <a name="collections--checkpoint"></a>`collections::checkpoint`
...
```puppet
collections::checkpoint { 'namevar': }
```
...
* [`merge_options`](#-collections--create--merge_options)
...
##### <a name="-collections--create--merge_options"></a>`merge_options`
...
### <a name="collections--file--writer"></a>`collections::file::writer`
...
The following parameters are available in the `collections::file::writer` defined type:

* [`target`](#-collections--file--writer--target)
* [`items`](#-collections--file--writer--items)
* [`file`](#-collections--file--writer--file)
* [`template`](#-collections--file--writer--template)

##### <a name="-collections--file--writer--target"></a>`target`
...
##### <a name="-collections--file--writer--items"></a>`items`
...
##### <a name="-collections--file--writer--file"></a>`file`
...
##### <a name="-collections--file--writer--template"></a>`template`
...
### <a name="collections--iterator"></a>`collections::iterator`
...
The following parameters are available in the `collections::iterator` defined type:

* [`items`](#-collections--iterator--items)
* [`executors`](#-collections--iterator--executors)
* [`actions`](#-collections--iterator--actions)

##### <a name="-collections--iterator--items"></a>`items`

Data type: `Array[Any]`

The collected items which will be processed by actions and executors

##### <a name="-collections--iterator--executors"></a>`executors`

Data type: `Array[Struct[{resource=>String,parameters=>Hash}]]`

The names of defined_types which will be instantiated, passing in the
complete item set as `items`

##### <a name="-collections--iterator--actions"></a>`actions`
